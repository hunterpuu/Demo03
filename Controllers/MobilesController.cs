...
namespace Demo03.Controllers
{
    public class MobilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Devices,Os,Brands")] Mobile mobile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Devices,Os,Brands")] Mobile mobile)
        {
            if (id != mobile.Id)
            {
                return NotFound();
